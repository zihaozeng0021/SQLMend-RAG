...
- `evaluation/complementarity_report.json` — `CREATED`
- `evaluation/confidence_intervals.json` — `CREATED`
- `evaluation/judged_coverage.json` — `CREATED`
- `evaluation/latency.json` — `CREATED`
- `evaluation/overall_metrics.json` — `CREATED`
- `evaluation/pairwise_differences.json` — `CREATED`
- `evaluation/per_query_metrics.csv` — `CREATED`
- `evaluation/run_determinism.json` — `CREATED`
- `evaluation/slice_metrics.csv` — `CREATED`
...
- `src/sqlmend_retrieval.egg-info/PKG-INFO` — `CREATED`
- `src/sqlmend_retrieval.egg-info/SOURCES.txt` — `CREATED`
- `src/sqlmend_retrieval.egg-info/dependency_links.txt` — `CREATED`
- `src/sqlmend_retrieval.egg-info/entry_points.txt` — `CREATED`
- `src/sqlmend_retrieval.egg-info/requires.txt` — `CREATED`
- `src/sqlmend_retrieval.egg-info/top_level.txt` — `CREATED`
...
```json
{
  ...
  "after_tree_sha256": "9b1b97126cc678effded5ef866ddcff02fe47639ed6db16f39b08c94f630cb7b",
  "before_file_count": 8481,
  "before_tree_sha256": "9b1b97126cc678effded5ef866ddcff02fe47639ed6db16f39b08c94f630cb7b",
...
[
  {
    "reason": "all recorded checks passed",
    "status": "NONE"
  }
]
```
